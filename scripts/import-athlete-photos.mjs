...
const args = new Set(cli)
const importAll=args.has('--all'), refresh=args.has('--refresh'), dryRun=args.has('--dry-run'), auditWeak=args.has('--audit-weak')
